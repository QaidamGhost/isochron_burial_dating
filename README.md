...
## Instruction
 0. The scripts assume the ratio of surface production rates as 6.61 which is indicated by the mean life of 10Be and 26Al adopted here. Try to modify the production rates and mean life in the codes if you want to switch to a different value, or the results will show inaccuracy.
