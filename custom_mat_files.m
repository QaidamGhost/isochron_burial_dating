...
%% Generate "e.mat" and "expo_age.mat" if you want to calculate the lower limit of the isochron burial age and already know the value and absolute 1 sigma error of erosion rate and exposure age.
